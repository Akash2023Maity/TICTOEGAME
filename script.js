...
/* maswork function declearation*/
function maswork(winner){
   if(winner==1){
       document.getElementById("p1wposter").style.display="none";
   }
   else if(winner==2){
        document.getElementById("p2wposter").style.display="none";
    }
   else if(winner==0){
       document.getElementById("newposter").style.display="none";
   }
}
...
function gamework(element){
    ...
    if(schange=="True"){
       if((box1=="cross"&&box2=="cross"&&box3=="cross")||(box1=="cross"&&box4=="cross"&&box7=="cross")||(box1=="cross"&&box5=="cross"&&box9=="cross")||(box2=="cross"&&box5=="cross"&&box8=="cross")||(box3=="cross"&&box6=="cross"&&box9=="cross")||(box3=="cross"&&box5=="cross"&&box7=="cross")||(box4=="cross"&&box5=="cross"&&box6=="cross")){
          document.getElementById("p1wposter").style.display="block";
        ...
        var myTimeout2 = setTimeout(function() {
         maswork(1);
           ...
           document.getElementById("p2wposter").style.display="block";
           var myTimeout = setTimeout(function() {
         refreshwork(2);
      }, 800);
       ...
       var myTimeout2 = setTimeout(function() {
         maswork(2);
          ...
          document.getElementById("newposter").style.display="block";
           var myTimeout = setTimeout(function() {
         refreshwork(0);
      }, 800);
